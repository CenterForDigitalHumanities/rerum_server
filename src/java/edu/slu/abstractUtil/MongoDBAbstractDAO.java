       ...
       // System.out.println("Bulk Set ID");
        ...
        for(int j=0; j<size; j++){
          //  System.out.println("set id "+j);
            ...
            targetEntity.put("@id", "http://store.rerum.io/rerumstore/id/"+(targetEntity.get("_id").toString()));
            ...
            toUpdate.put("@id", "http://store.rerum.io/rerumstore/id/"+(targetEntity.get("_id").toString()));
