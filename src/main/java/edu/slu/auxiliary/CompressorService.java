...
public class CompressorService {
    ...
    private final String[] illegalKeys = {
        "__rerum"
    };
    ...
    /**
     * Initialize default compressing, where to object to compress is provided.
    ...
    /**
     * Initialize the compressor, where the keys to keep are provided as an array
     * @param toCompress A JSONObject to compress and return.
